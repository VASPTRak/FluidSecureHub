...
import com.TrakEngineering.FluidSecureHub.entity.WifiEntityClass;
    ...
    public class GetSitListAsynTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                response = serverHandler.PostTextData(MainActivity.this, AppConstants.WEB_URL, latLong, authString);
                //----------------------------------------------------------------------------------
