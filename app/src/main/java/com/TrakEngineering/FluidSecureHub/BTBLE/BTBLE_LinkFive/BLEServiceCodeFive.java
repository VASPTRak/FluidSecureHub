package com.TrakEngineering.FluidSecureHub.BTBLE.BTBLE_LinkFive;
...
public class BLEServiceCodeFive extends Service {
    private static final String TAG = "BLEService_Five";
    ...
    public ConnectionDetector cd = new ConnectionDetector(BLEServiceCodeFive.this);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                BT_BLE_Constants.BT_BLE_LINK_FIVE_STATUS = true;
                BT_BLE_Constants.BT_BLE_STATUS_STR_FIVE = "Connected";
                ...
                BT_BLE_Constants.BT_BLE_STATUS_STR_FIVE = "Disconnect";
                //broadcastUpdate(intentAction);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            //BLEService_Five broadcastUpdate ==> Response:>> {"T":"77637","D":"23
            //BLEService_Five broadcastUpdate ==> Response:>> 1013165559","V":""}$
            //BLEService_Five broadcastUpdate ==> Response:>> $ �?   )^����?���?
            // ===========================================================================

            if (Response.contains("$$") || sb5.toString().trim().contains("$$")) {
                if (sb5.toString().trim().contains("$$")) {
                    Response = sb5.toString().trim();
                }
                ...
                if (BT_BLE_Constants.IS_NEW_VERSION_LINK_FIVE || BTConstants.FOR_OSCILLOSCOPE || BT_BLE_Constants.CURRENT_COMMAND_LINK_FIVE.contains(BTConstants.P_TYPE_COMMAND)) {
                    sb5.append(Response);
                } else {
    ...
    public class LocalBinder extends Binder {
        public BLEServiceCodeFive getService() {
            return BLEServiceCodeFive.this;
        }
    }
    ...
    private final IBinder mBinder = new BLEServiceCodeFive.LocalBinder();
    ...
    public void writeCustomCharacteristic(String bleCommand) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            BT_BLE_Constants.CURRENT_COMMAND_LINK_FIVE = "";
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
        ...
        if (!bleCommand.equalsIgnoreCase(BTConstants.FD_CHECK_COMMAND)) {
            BT_BLE_Constants.CURRENT_COMMAND_LINK_FIVE = bleCommand;
        }
