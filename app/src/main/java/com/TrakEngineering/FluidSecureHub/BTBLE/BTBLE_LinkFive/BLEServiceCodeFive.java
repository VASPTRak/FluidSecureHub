...
public class BLEServiceCodeFive extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                BT_BLE_Constants.BTBLELinkFiveStatus = true;
                BT_BLE_Constants.BTBLEStatusStrFive = "Connected";
                ...
                BT_BLE_Constants.BTBLEStatusStrFive = "Disconnect";
                //broadcastUpdate(intentAction);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            if (Response.contains("$$") || sb5.toString().trim().contains("$$")) {
                ...
                if (BT_BLE_Constants.isNewVersionLinkFive || BTConstants.forOscilloscope || BT_BLE_Constants.CurrentCommand_LinkFive.contains(BTConstants.p_type_command)) {
                    sb5.append(Response);
                } else {
    ...
    public void writeCustomCharacteristic(String bleCommand) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            BT_BLE_Constants.CurrentCommand_LinkFive = "";
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
        ...
        BT_BLE_Constants.CurrentCommand_LinkFive = bleCommand;
