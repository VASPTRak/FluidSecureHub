...
public class BS_BLE_BTFive extends Service {
    private static final String TAG = AppConstants.LOG_TXTN_BT + "- BLE_Link 5:";
    ...
    public void ContinueToNextCommand() {
        //if (versionNumberOfLinkFive >= 148) { // Bypass pump reset supported from this version onwards
