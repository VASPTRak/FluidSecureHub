package com.TrakEngineering.FluidSecureHub.BTBLE.BTBLE_LinkOne;
...
public class BLEServiceCodeOne extends Service {
    private static final String TAG = "BLEService_One";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                BT_BLE_Constants.BT_BLE_LINK_ONE_STATUS = true;
                BT_BLE_Constants.BT_BLE_STATUS_STR_ONE = "Connected";
                ...
                BT_BLE_Constants.BT_BLE_STATUS_STR_ONE = "Disconnect";
                //broadcastUpdate(intentAction);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            if (Response.contains("$$") || sb1.toString().trim().contains("$$")) {
                ...
                if (BT_BLE_Constants.IS_NEW_VERSION_LINK_ONE || BTConstants.FOR_OSCILLOSCOPE || BT_BLE_Constants.CURRENT_COMMAND_LINK_ONE.contains(BTConstants.P_TYPE_COMMAND)) {
                    sb1.append(Response);
                } else {
    ...
    public class LocalBinder extends Binder {
        public BLEServiceCodeOne getService() {
            return BLEServiceCodeOne.this;
        }
    }
    ...
    private final IBinder mBinder = new BLEServiceCodeOne.LocalBinder();
    ...
    public void writeCustomCharacteristic(String bleCommand) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            BT_BLE_Constants.CURRENT_COMMAND_LINK_ONE = "";
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
        ...
        if (!bleCommand.equalsIgnoreCase(BTConstants.FD_CHECK_COMMAND)) {
            BT_BLE_Constants.CURRENT_COMMAND_LINK_ONE = bleCommand;
        }
