...
public class BLEServiceCodeFour extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                BT_BLE_Constants.BTBLELinkFourStatus = true;
                BT_BLE_Constants.BTBLEStatusStrFour = "Connected";
                ...
                BT_BLE_Constants.BTBLEStatusStrFour = "Disconnect";
                //broadcastUpdate(intentAction);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            if (Response.contains("$$") || sb4.toString().trim().contains("$$")) {
                ...
                if (BT_BLE_Constants.isNewVersionLinkFour || BTConstants.forOscilloscope || BT_BLE_Constants.CurrentCommand_LinkFour.contains(BTConstants.p_type_command)) {
                    sb4.append(Response);
                } else {
    ...
    public void writeCustomCharacteristic(String bleCommand) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            BT_BLE_Constants.CurrentCommand_LinkFour = "";
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
        ...
        BT_BLE_Constants.CurrentCommand_LinkFour = bleCommand;
