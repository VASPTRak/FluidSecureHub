package com.TrakEngineering.FluidSecureHub.BTBLE.BTBLE_LinkFour;
...
public class BLEServiceCodeFour extends Service {
    private static final String TAG = "BLEService_Four";
    ...
    public ConnectionDetector cd = new ConnectionDetector(BLEServiceCodeFour.this);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                BT_BLE_Constants.BT_BLE_LINK_FOUR_STATUS = true;
                BT_BLE_Constants.BT_BLE_STATUS_STR_FOUR = "Connected";
                ...
                BT_BLE_Constants.BT_BLE_STATUS_STR_FOUR = "Disconnect";
                //broadcastUpdate(intentAction);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            //BLEService_Four broadcastUpdate ==> Response:>> {"T":"77637","D":"23
            //BLEService_Four broadcastUpdate ==> Response:>> 1013165559","V":""}$
            //BLEService_Four broadcastUpdate ==> Response:>> $ �?   )^����?���?
            // ===========================================================================

            if (Response.contains("$$") || sb4.toString().trim().contains("$$")) {
                if (sb4.toString().trim().contains("$$")) {
                    Response = sb4.toString().trim();
                }
                ...
                if (BT_BLE_Constants.IS_NEW_VERSION_LINK_FOUR || BTConstants.FOR_OSCILLOSCOPE || BT_BLE_Constants.CURRENT_COMMAND_LINK_FOUR.contains(BTConstants.P_TYPE_COMMAND)) {
                    sb4.append(Response);
                } else {
    ...
    public class LocalBinder extends Binder {
        public BLEServiceCodeFour getService() {
            return BLEServiceCodeFour.this;
        }
    }
    ...
    private final IBinder mBinder = new BLEServiceCodeFour.LocalBinder();
    ...
    public void writeCustomCharacteristic(String bleCommand) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            BT_BLE_Constants.CURRENT_COMMAND_LINK_FOUR = "";
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
        ...
        if (!bleCommand.equalsIgnoreCase(BTConstants.FD_CHECK_COMMAND)) {
            BT_BLE_Constants.CURRENT_COMMAND_LINK_FOUR = bleCommand;
        }
