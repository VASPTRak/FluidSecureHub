  ...
  /*  public void startTimerFirst() {
    ...
    public class CommandsGET_Info extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String FSStatus) {
            ...
            try {
                pd.dismiss();
                if ((AppConstants.excption_caught || FSStatus.equalsIgnoreCase("")) && count_toggle == 0) {
                    count_toggle = 1;
                    if (Constants.FS_1STATUS.equalsIgnoreCase("FREE") && Constants.FS_2STATUS.equalsIgnoreCase("FREE") && Constants.FS_3STATUS.equalsIgnoreCase("FREE") && Constants.FS_4STATUS.equalsIgnoreCase("FREE") && Constants.FS_5STATUS.equalsIgnoreCase("FREE") && Constants.FS_6STATUS.equalsIgnoreCase("FREE")) {
                        ...
                        AppConstants.WriteinFile(TAG+" refreshing hotpot canceled, other hose is busy, info cmd fail");
                    }
