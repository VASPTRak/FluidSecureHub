        ...
        try {
            ...
            if (extras == null) {
                ...
                if (LinkCommunicationType.equalsIgnoreCase("BT")) {
                    ...
                    if (checkBTLinkStatus(false)) { //BTConstants.BTStatusStrSix.equalsIgnoreCase("Connected")
            ...
            new CountDownTimer(12000, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    ...
                    if (ssid.equalsIgnoreCase(LinkName)) {
                        if (AppConstants.GenerateLogs)
                            AppConstants.WriteinFile(TAG + " BTLink 6: Connected to WiFi " + ssid);
            ...
            new CountDownTimer(10000, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    try {
                        ...
                        e.printStackTrace();
                        if (AppConstants.GenerateLogs)
                            AppConstants.WriteinFile(TAG + " BTLink 6: upgrade command Exception. Exception: " + e.getMessage());
                    }
                }
    ...
    public class BTLinkUpgradeFunctionality extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                if (AppConstants.GenerateLogs)
                    AppConstants.WriteinFile(TAG + " BTLink 6: BTLinkUpgradeFunctionality InBackground Exception: " + e.getMessage());
            }
