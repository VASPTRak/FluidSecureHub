...
public class BackgroundService_BTThree extends Service {
    ...
    private void infoCommand() {
        try {
            BTConstants.IS_NEW_VERSION_LINK_THREE = false;
            ...
            if (IsThisBTTrnx) {
                ...
                btspp.send3(BTConstants.INFO_COMMAND);
            }
                            ...
                            if (!TransactionId.isEmpty()) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        //if (IsThisBTTrnx && BTConstants.IS_NEW_VERSION_LINK_THREE && CommonUtils.checkBTVersionCompatibility(versionNumberOfLinkThree, BTConstants.SUPPORTED_LINK_VERSION_FOR_LAST1)) {
                                        //    last1Command();
                                        //} else {
                    ...
                    if (Request.equalsIgnoreCase(BTConstants.INFO_COMMAND) && !Response.equalsIgnoreCase("")) {
                        ...
                        if (infoCommandAttempt > 0) {
                            ...
                            if (BTConstants.BT_STATUS_STR_THREE.equalsIgnoreCase("Connected")) {
                                ...
                                BTConstants.RETRY_CONN_FOR_INFO_COMMAND3 = true;
    ...
    private void last1Command() {
        try {
            ...
            if (IsThisBTTrnx) {
                ...
                BTSPPMain btspp = new BTSPPMain();
                btspp.send3(BTConstants.LAST1_COMMAND);
            }
    ...
    private void relayOnCommand(boolean isAfterReconnect) {
        try {
            ...
            if (IsThisBTTrnx) {
                ...
                BTSPPMain btspp = new BTSPPMain();
                btspp.send3(BTConstants.RELAY_ON_COMMAND);
            }
    ...
    private void renameCommand() {
        try {
            ...
            if (IsThisBTTrnx) {
                if (AppConstants.GENERATE_LOGS)
                    AppConstants.writeInFile(TAG + " BTLink_3: Sending rename command to Link: " + LinkName + " (New Name: " + BTConstants.BT3_REPLACEABLE_WIFI_NAME + ")");
                BTSPPMain btspp = new BTSPPMain();
                btspp.send3(BTConstants.RENAME_COMMAND + BTConstants.BT3_REPLACEABLE_WIFI_NAME);
            }
    ...
    private void last20Command() {
        try {
            ...
            if (IsThisBTTrnx) {
                ...
                BTSPPMain btspp = new BTSPPMain();
                btspp.send3(BTConstants.LAST20_COMMAND);
            }
            ...
            if (IsCheckMOStatus != null) {
                if (IsCheckMOStatus.trim().equalsIgnoreCase("True") && !MOStatusCheckFlag.isEmpty() && !CommonUtils.CheckDataStoredInSharedPref(BackgroundService_BTThree.this, "storeCheckMOStatusFlag3")) {
                    ...
                    if (IsThisBTTrnx) {
                        ...
                        BTSPPMain btspp = new BTSPPMain();
                        btspp.send3(BTConstants.CHECK_MO_STATUS_COMMAND + MOStatusCheckFlag);
                    }
            ...
            if (IsResetMOCheckFlag != null) {
                if (IsResetMOCheckFlag.trim().equalsIgnoreCase("True") && !CommonUtils.CheckDataStoredInSharedPref(BackgroundService_BTThree.this, "storeResetMOCheckFlag3")) {
                    ...
                    if (IsThisBTTrnx) {
                        ...
                        BTSPPMain btspp = new BTSPPMain();
                        btspp.send3(BTConstants.RESET_MO_CHECK_FLAG_COMMAND);
                    }
            ...
            new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                ...
                public void run() {
                    if (isHotspotDisabled) {
                        ...
                        if (!CommonUtils.isHotspotEnabled(BackgroundService_BTThree.this) && !AppConstants.IS_ALL_LINKS_ARE_BT_LINKS) {
                            if (AppConstants.GENERATE_LOGS)
    ...
    private void pulseCount() {
        try {
            ...
            e.printStackTrace();
            //if (AppConstants.GENERATE_LOGS)AppConstants.writeInFile(TAG + " BTLink_3: pulse count Exception>>" + e.getMessage());
        }
    }
    ...
    private void insertInitialTransactionToSqlite() {
        ...
        if (AppConstants.GENERATE_LOGS)
            AppConstants.writeInFile(TAG + " BTLink_3: <Transaction saved in local DB. LocalTxnId: " + sqliteID + "; LINK: " + LinkName + ">");
    ...
    private void checkResponse() {
        try {
            if (RelayStatus && !BTConstants.CURRENT_COMMAND_LINK_THREE.contains(BTConstants.RELAY_OFF_COMMAND)) {
                if (RespCount < 4) {
                    RespCount++;
                } else {
                    RespCount = 0;
    ...
    private void fdCheckCommand() {
        try {
            ...
            if (IsThisBTTrnx) {
                ...
                BTSPPMain btspp = new BTSPPMain();
                btspp.send3(BTConstants.FD_CHECK_COMMAND);
            }
        } catch (Exception ex) {
            if (AppConstants.GENERATE_LOGS)
    ...
    private void parseInfoCommandResponse(String response) {
        try {
            ...
            storeUpgradeFSVersion(BackgroundService_BTThree.this, AppConstants.UP_HOSE_ID_FS3, version);
    ...
    public class UpgradeCurrentVersionWithUpgradableVersion extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            try {
                ...
                response = serverHandler.PostTextData(BackgroundService_BTThree.this, AppConstants.WEB_URL, jsonData, authString);
                //----------------------------------------------------------------------------------
