package com.TrakEngineering.FluidSecureHub.MagV2GAtt;
...
public class LeServiceMagV2 extends Service {
    private final static String TAG = LeServiceMagV2.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        public LeServiceMagV2 getService() {
            return LeServiceMagV2.this;
        }
    }
    ...
    private final IBinder mBinder = new LeServiceMagV2.LocalBinder();
