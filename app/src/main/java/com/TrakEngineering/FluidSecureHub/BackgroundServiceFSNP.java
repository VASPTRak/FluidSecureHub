            ...
            public void run() {
                ...
                while (!isInterrupted()) {
                    ...
                    if (AppConstants.ENABLE_FA) {
                        ...
                        //Log.e(TAG, " FAEnabled  AppConstants.ENABLE_FA:"+AppConstants.ENABLE_FA);
    ...
    public class CheckAndValidateFSNPDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                response = serverHandler.PostTextData(BackgroundServiceFSNP.this, AppConstants.WEB_URL, jsonData, authString);
