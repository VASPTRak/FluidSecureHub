...
public class AcceptVehicleActivity_new extends AppCompatActivity implements ServiceConnection, FStagScannerService.OnBeaconEventListener {
    ...
    String IsExtraOther = "", ExtraOtherLabel = "", FSTagMacAddress = "", IsVehicleHasFob = "", IsOdoMeterRequire = "", IsDepartmentRequire = "", IsPersonnelPINRequire = "", IsPersonnelPINRequireForHub = "", IsOtherRequire = "", IsVehicleNumberRequire = "", IsStayOpenGate = "", IsGateHub = "", IsHoursRequire = "",IsNonValidatePerson = "",IsNonValidateVehicle ="";
    ...
    public void FobreadSuccess() {
        ...
        if (MagCard_vehicle != null && !MagCard_vehicle.isEmpty()) {
            ...
            if (cd.isConnectingToInternet() && AppConstants.NETWORK_STRENGTH && IsNonValidateVehicle.equalsIgnoreCase("True")) {
            ...
            if (IsNonValidateVehicle.equalsIgnoreCase("True")){
                ...
                Log.i("ps_Vechile no", "Step 1:" + fob);
